...
import { OumaPortfolioTrailParticle } from "../particles/OumaPortfolioTrail"
...
export class Projet1OumaPortfolioEmitter extends Emitter {
  constructor(sim, light, startPosition, enemy) {
    ...
    const particles = {
      smoke: new OumaPortfolioTrailParticle({
        color,
      }),
      sparkle: new OumaPortfolioTrailParticle({
        style: PARTICLE_STYLES.point,
        scale: 0.1,
      }),
      circle: new OumaPortfolioTrailParticle({
        color,
    ...
    SOUNDS.play("OumaPortfolio-travel")
