...
export class Stage {
  constructor(mount) {
    ...
    this.cameraPositions = {
      ...
      AvatarOffset: { x: 0, y: 0.02, z: 0.2 },
      AvatarIntro: { x: 0, y: 0.02, z: 0.3 },
      service: { x: 0.05, y: -0.1, z: 0.3 },
      Avatar: { x: 0, y: 0.02, z: 0.3 },
      bookshelf: { x: 0, y: 0, z: 0.2 },
      OumaPortfolioLesson: { x: 0.1, y: 0.3, z: 1.2 },
    ...
    this.cameraLookAts = {
      ...
      AvatarOffset: { x: 0.05, y: -0.065, z: 0 },
      AvatarIntro: { x: 0, y: -0.1, z: 0 },
      service: { x: -0.2, y: -0.1, z: -0.2 },
      Avatar: { x: 0, y: -0.065, z: 0 },
      bookshelf: { x: -0.3, y: -0.07, z: -0.15 },
      OumaPortfolioLesson: { x: 0.15, y: -0.12, z: 0 },
